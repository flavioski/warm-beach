    ...
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                ...
                <h3><a href="http://demo.adminlte.acacha.org/login" class="btn btn-lg btn-success">Get Started!</a></h3>
            </div>
            <div class="col-lg-2">
                <h5>Amazing admin template</h5>
                <p>Based on adminlte bootstrap theme</p>
                <img class="hidden-xs hidden-sm hidden-md" src="http://demo.adminlte.acacha.org/img/arrow1.png">
            </div>
            <div class="col-lg-8">
                <img class="img-responsive" src="http://demo.adminlte.acacha.org/img/app-bg.png" alt="">
            </div>
            <div class="col-lg-2">
                <br>
                <img class="hidden-xs hidden-sm hidden-md" src="http://demo.adminlte.acacha.org/img/arrow2.png">
